      ...
      <Container>
        <VStack spacing={8}>
          ...
          <Text color="bodyText" fontSize="xl" textAlign="center">
            Each mistighost is randomly generated and can be staked to receive
            <Text as="b"> $BLD</Text> Use your <Text as="b"> $BLD</Text> to
            upgrade your mistighost and receive perks within the community!
          </Text>
        </VStack>
      </Container>
